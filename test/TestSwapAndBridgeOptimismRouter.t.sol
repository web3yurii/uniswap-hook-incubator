...
contract TestSwapAndBridgeOptimismRouter is Test, Deployers {
    ...
    uint256 sepoliaForkId = vm.createFork("https://endpoints.omniatech.io/v1/eth/sepolia/public");
    ...
    function setUp() public {
        ...
        (key,) = initPool(
            Currency.wrap(address(0)), Currency.wrap(address(OUTbL1Token)), IHooks(address(0)), 3000, SQRT_PRICE_1_1
        );
